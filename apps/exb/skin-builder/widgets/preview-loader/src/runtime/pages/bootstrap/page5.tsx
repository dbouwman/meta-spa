...
export class Page5 extends React.PureComponent<{}, any> {
  ...
  togglePopup() {
    this.setState(prevState => ({
      tooltip: this.state.tooltip.set('open', !prevState.tooltip.open)
    }))
  }
    ...
    return (
      <div>
        ...
        <div className='mb-3'>
          ...
          <Popover placement='bottom' isOpen={this.state.popover.open} target='Popover1' toggle={this.togglePopover}>
